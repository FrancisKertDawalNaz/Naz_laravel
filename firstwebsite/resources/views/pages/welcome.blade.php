                        ...
                        <div class="card-body p-5">
                            ...
                            <form method="POST" action="/login">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-lg rounded-3" placeholder="Enter your email" required autofocus style="font-size: 0.95rem;">
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary w-100 py-2 rounded-3" style="background: linear-gradient(90deg, #6366f1 0%, #a855f7 100%); border: none; font-size: 1rem;">Login</button>
                            </form>
                            <div class="mb-3 text-center">
                                <a href="/register" class="small text-decoration-none" style="color:#6366f1;">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
